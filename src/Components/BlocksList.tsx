      ...
      {!isVisible ? (
        <View style={styles.addButton}>
          <TouchableOpacity
            ...
            <Icon name="circle-with-plus" type="entypo" size={75} />
          </TouchableOpacity>
        </View>
      ) : undefined}

      <ScrollView ref={scrollViewRef} style={isVisible ? styles.darkCommonView : styles.commonView}>
        <Modal
          animationType={"fade"}
          transparent={true}
          visible={isVisible}
